...
BEGIN
  -- Block non-dpconsorcios emails
  IF NEW.email IS NULL OR NEW.email NOT LIKE '%@dpconsorcios.com.br' THEN
    RAISE EXCEPTION 'Apenas e-mails @dpconsorcios.com.br são permitidos';
  END IF;
