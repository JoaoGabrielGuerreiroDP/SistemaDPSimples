...
const EMBED_URL = "https://wonder-nav.lovable.app";

export default function DPNavigatorBuddy() {
  return (
    <div className="flex flex-col h-[calc(100vh-2.75rem)] w-full">
      <div className="flex items-center justify-between border-b border-border/50 bg-background/80 px-4 py-2">
        <h1 className="text-sm font-semibold tracking-wide">Navigator Buddy</h1>
        <Button
          variant="outline"
          size="sm"
